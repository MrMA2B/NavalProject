...
public class Jeu implements Serializable {
	...
	public void newGame() {
		...
		while ((generalPvH > 0) && (generalPvR > 0)) {
			...
			// Rq on affiche notre Grille et celle du Robot en cachée
			...
			if (actionChoice == 1) {
				...
				while (!listOfBoatRadomTargetChoice.contains(targetChoice)) {
					...
					System.out.println("S1, S2, S3, S4, D1, D2, D3, F1, F2, C0");
					System.out.print("\nDepuis quel navire voulez-vous tirer ?");
		...
		if (generalPvH == 0) {
			...
			System.out.println(
					"Bravo vous avez été plus fort que le robot Amiral ! Vous avez gagné en " + tour + " tours");
